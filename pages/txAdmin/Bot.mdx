...
- Under Scopes, <LinkButton text={"select"} image={"https://r2.fivemanage.com/image/kUimNPQ4CM5l.png"}/> bot.
...
- Ensure <LinkButton text={"Privileged Gateway Intents"} image={"https://r2.fivemanage.com/image/gb7A4G3Ridzk.png"}/> are enabled on the same page (scroll down).
...
- You should now be at a page that looks like <LinkButton text={"this"} image={"https://r2.fivemanage.com/image/FnS2m01FdVHF.png"}/>.
