...
1. Make an export of your Database:
   ...
   - **PHPMyAdmin**: https://help.dreamhost.com/hc/en-us/articles/214395738-phpMyAdmin-How-to-backup-or-export-a-database-or-table
...
- Now once you have done all these actions, it's time to setup the database the correct way, please click [this](https://docs.yorick.gg/FiveM/Server/Windows/Database) link:
