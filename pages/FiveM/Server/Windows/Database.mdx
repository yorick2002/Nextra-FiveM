...
- Select MariaDB Server Version **11.4.5**
...
HeidiSQl will be installed by default with MariaDB. You dont need to install it separately.
</Callout>
...
<Callout type="warning">
Most Frameworks will create the database for you, but if you want to do it manually, follow these steps.
</Callout>
