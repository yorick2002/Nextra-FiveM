...
Make a back-up of your server's resources and database. How this works is dependent on what you use to manage your database. Consult Google for help. Make sure to **exclude** the resources with the backdoor. If you import these files again, you will face the exact same issue very quickly. The backdoor is removed from the resource when you delete the file/code responsible for the backdoor. You can also choose to delete the file and download it again via it's original source.
...
Try your best to get your resources from official channels such as the [Cfx forum](https://forum.cfx.re/c/releases/7) or the [Cfx Marketplace](https://marketplace.cfx.re/). When you get resources from Github, make sure they are safe to use by reviewing the code.
